...
MobiConnect provides API calls, CL commands and other integrations for IBM i, Windows, Linux, MacOS and more.   
...
- Open source integration to classic RPG and CL programs

### Windows, Linux and MacOS
- Custom apps for Windows
- backgrond services
- API integrations
